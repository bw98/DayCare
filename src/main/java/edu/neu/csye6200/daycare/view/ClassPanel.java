...
import edu.neu.csye6200.daycare.controller.ClassRoomRule;
import edu.neu.csye6200.daycare.controller.GroupRule;
...
import edu.neu.csye6200.daycare.model.Teachers;
	...
	public Item toItem() {
	        ...
	        generateButton.addActionListener(new ActionListener() {
	            ...
	            public void actionPerformed(ActionEvent e) {
	                ...
	                Students ss = Students.parseStudents("src"+sep+"main"+sep+"resources"+sep+"students.csv");
	                Teachers ts = Teachers.parseTeachers("src"+sep+"main"+sep+"resources"+sep+"teachers.csv");
	                try {
