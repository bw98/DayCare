...
import edu.neu.csye6200.daycare.controller.vaccinecontroller.GetStudents;
import edu.neu.csye6200.daycare.model.Vaccine;
import edu.neu.csye6200.daycare.controller.vaccinecontroller.VaccineFactory;
import edu.neu.csye6200.daycare.controller.vaccinecontroller.VaccineNotification;
...
public class VaccinePanel{
    ...
    public static void writeVaccine(int id, String vaccine) throws IOException {
        ...
        List<Student> students = GetStudents.get();
        int row = 0;
        File file = new File("src"+sep+"main"+sep+"resources"+sep+"vaccine.csv");
        Student s = null;
