...
public class TeacherReviewPanel extends JPanel{
	...
	String[] titles= {"id","age","credits","register date","review date","name","phone","address"};
	...
	public Item toItem() {
		return new Item("Teacher Information", this,new ActionListener() {
	...
	public Object[][] get_data() {
		...
		ts=new Teachers("src"+sep+"main"+sep+"resources"+sep+"teachers.csv");
	...
	public void renew_person(ActionEvent e) throws Exception {
		...
		for(int i: selectedRows) {
			...
			String sep=File.separator;
			ts.write_to_csv("src"+sep+"main"+sep+"resources"+sep+"teachers.csv");
		}
	}
